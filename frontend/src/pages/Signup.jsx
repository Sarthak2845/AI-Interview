      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden
        ...
        <div className="relative">
          ...
          <p className="text-white/70 leading-relaxed max-w-sm mb-10">
            Join thousands of candidates who use Jankoti to prepare smarter and land better jobs.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-800 mt-1.5">Start practicing interviews for free</p>
          </div>
